...
Holdout: 2025 season. Metric definitions: MAE (mean absolute error in fantasy points), R² (coefficient of determination). The table and takeaways below are a **2026-07-04 snapshot**, from the full six-position Batch (Spot) run [benchmark_history/2026-07-04T22-33-39_6590a2a.json](benchmark_history/2026-07-04T22-33-39_6590a2a.json) (commit `6590a2a`, PR #1460). That run predates the split-mode ranking fix, so its placeholder-zero top-12 values are omitted. Split Batch runs record top-12 again since PR #1486; the later full six-position run [benchmark_history/2026-07-13T10-49-31_40b08a1.json](benchmark_history/2026-07-13T10-49-31_40b08a1.json) records nonzero values for all four model families at every position. Top-12 hit rate measures agreement with the actual weekly top 12 at the position under PPR scoring.
...
**Takeaways:**
- **The NN families take every position except K in this July 4 snapshot.** The Attention NN leads QB (5.705), WR (3.971), and DST (5.033); the plain MultiHeadNet leads RB (4.042) and TE (3.362); Ridge holds K. LightGBM wins no position on MAE but posts the best R² at QB (0.403), WR (0.385), and TE (0.362), and ties the Attention NN for best at RB (0.473) — most per-position margins sit within run-to-run noise.
