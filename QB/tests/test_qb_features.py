"""Tests for QB.qb_features — _compute_qb_features and fill_qb_nans."""

import numpy as np
import pandas as pd
import pytest

from QB.qb_features import _compute_qb_features, fill_qb_nans
...
class TestComputeQBFeatures:
    ...
    def test_qb_rushing_share_computation(self):
...
class TestFillQBNans:
    ...
    def test_multiple_columns(self):
        ...
        train, val, test = fill_qb_nans(train, val, test, ["f1", "f2"])
