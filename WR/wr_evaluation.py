"""WR-specific evaluation utilities."""
...
def compute_wr_metrics(y_true_dict: dict, y_pred_dict: dict) -> dict:
    """Compute per-target and total metrics for WR model.
...
def compute_wr_ranking_metrics(
    test_df: pd.DataFrame,
    pred_col: str = "pred_total",
    true_col: str = "fantasy_points",
    top_k: int = 12,
) -> dict:
    """Per-week ranking quality metrics for WR model.
...
def print_wr_comparison_table(results: dict) -> None:
    """Pretty-print comparison of all WR models."""
    print("\n" + "=" * 80)
    print("WR Model Comparison -- Total Fantasy Points")
    print("=" * 80)
    ...
    print("\n" + "=" * 80)
    print("WR Model Comparison -- Per-Target MAE")
    print("=" * 80)
