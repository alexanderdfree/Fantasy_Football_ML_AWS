...
def _patch_all(monkeypatch):
    ...
    re-executes the script: the fresh ``from K.k_data import load_kicker_data``
    ...
    import K.k_features as k_features
    import K.k_targets as k_targets
    import K.run_k_pipeline as k_pipe
