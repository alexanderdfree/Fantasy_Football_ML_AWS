...
provenance is archived under
`s3://ff-predictor-training/ab_runs/cuda-capture-0f0fec55dfcd-20260910-od`
(`ok: true`). Spot capacity was unavailable; the isolated on-demand validation
used its own queue and at most one GPU instance.
