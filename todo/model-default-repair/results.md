...
Keep PRs #1575 and #1568 open. No candidate passed the complete development gate. No model policy, production default, merge, or deployment was approved by these results. #1534 remains dependent on #1575 with flags default-off.

This is a dated campaign report extracted from `98f0cd22c1b9fdf49cc6b805b52559c6f05d2399`. Subsequent main commits include #1578 (`110f21fe`) and #1479 (`f3730605`); the earlier hold on #1479 is not its current PR status. This extraction contains reporting/checking code only and does not promote any experimental model code.
...
- Baseline: `a9ae2a12a9ea3408d133d5bc231948cbea9b694a`. At campaign completion, main was `6d67c9871130b85804083a47dbb208e1f3dcffa7`, differing only by setup-uv action updates. This is historical evidence against that pinned baseline, not a fresh comparison against later main revisions.
