...
This is a dated 2026-08-24 hypothesis catalog. Scoring, cohorts, QB availability
and model policies have since changed or are under separate review. Recheck
activation preconditions and current-regime evidence before acting on any item.
This consolidation adds no production feature or training-policy defaults.
