            ...
            {payload && summary && (
                <>
                    ...
                    <details className="results-info">
                        ...
                        <p>Required sources: {sources.map((source) => labels[source] || source).join(", ")} — the same displayed sources as the Comparison tab, so both surfaces grade one common player-week set.</p>
