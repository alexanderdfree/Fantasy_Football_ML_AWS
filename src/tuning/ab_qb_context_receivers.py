...
Historical-proxy & serving notes: the role estimate is the **prior-to-W in-season expanding mean** of
...
historical participation proxy, not a timestamp-certified pregame availability feed.
This research screen does not establish live forecasting accuracy. Production
wiring would need the eligible pregame depth/roster selection documented for QB
and its separate archived replay, not current-week stat-row participation.
