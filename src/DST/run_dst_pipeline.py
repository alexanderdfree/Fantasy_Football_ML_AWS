...
DST_CONFIG = {
    ...
    "attn_static_features": DST_ATTN_STATIC_FEATURES,
    ...
    "lgbm_max_depth": DST_LGBM_MAX_DEPTH,
    ...
    "lgbm_min_split_gain": DST_LGBM_MIN_SPLIT_GAIN,
    "lgbm_objective": DST_LGBM_OBJECTIVE,
}
