"""Shared fixtures for DST tests — thin wrappers over src.shared.tests.position_fixtures.

Generic factories come from ``src/shared/tests/position_fixtures.py``; this
...
from src.DST.dst_config import DST_TARGETS  # noqa: E402
