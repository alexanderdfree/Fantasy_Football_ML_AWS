Compatibility wrapper for the Claude infrastructure-audit routine.
...
`.claude/routines/infrastructure-audit/prompt.md`. The shared source of truth is
`routines/infrastructure-audit/instructions.md`; do not add shared audit logic
here.
