...
- **AWS GPU quota (us-east-1):** 4 vCPU G OD (one g4dn.xlarge) + Spot G+VT 24 vCPU minimum (six 4-vCPU g6/g5 Batch hosts; live quota may be higher) — sized for the six-position fan-out; check before relying.
