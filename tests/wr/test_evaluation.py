"""Tests for src.shared.evaluation — compute_target_metrics, compute_ranking_metrics (WR targets)."""
...
class TestComputeRankingMetrics:
    ...
    def test_weeks_with_fewer_than_top_k_skipped(self):
        rows = [
            {"week": 1, "player_id": "WR1", "pred_total": 10, "fantasy_points": 10},
            {"week": 1, "player_id": "WR2", "pred_total": 8, "fantasy_points": 8},
        ]
