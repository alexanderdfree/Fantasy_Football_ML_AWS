...
generated by ``tests.shared.parameterized_targets``. DST-specific tests
(full linear+tier sum, raw counts pass-through, tier-boundary sweeps for
the PA/YA helpers) stay in this file.
...
from tests.dst.conftest import _build_dst_row
...
install_parameterized_targets(
    ...
    PositionTargetSpec(
        ...
        # DST's all-NaN path: 8 raw counts fall to 0; PA defaults to 21
        # (0 bonus), YA defaults to 350 (-1 bonus) -> fantasy_points = -1.
        nan_expected_zeros=(
            "def_sacks",
            "def_ints",
            "def_fumble_rec",
...
# ---------------------------------------------------------------------------
# DST-specific tests — raw counts pass-through + full linear+tier sum
# ---------------------------------------------------------------------------
