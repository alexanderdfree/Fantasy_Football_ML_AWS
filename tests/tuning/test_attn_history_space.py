...
def test_history_storage_namespace_is_separate():
    """History-scope studies must not share the scheduler_v3_fp_rmse_ppr_v1 namespace."""
    ...
    assert eager == "history_v3_fp_rmse_ppr_v1"
    ...
    assert (
        ...
        == "history_v3_fp_rmse_ppr_v1_mps_graph"
    )
