"""TE-specific Ridge regression multi-target model."""

import numpy as np
from src.models.linear import RidgeModel


class TERidgeMultiTarget:
    ...
    def save(self, model_dir: str = "TE/outputs/models") -> None:
    ...
    def load(self, model_dir: str = "TE/outputs/models") -> None:
