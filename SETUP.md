...
- **Durable vs incidental:** this syncs Claude's *incidental, machine-local* recall across your boxes. **Durable, share-worthy project knowledge belongs in version-controlled [AGENTS.md](AGENTS.md)** — the cross-agent source of truth both Claude Code and Codex read — not in synced auto-memory.
